...
--
-- Host: localhost:3306
-- Tempo de geração: 16/10/2017 às 12:07
...
CREATE TABLE `ADMIN` (
  ...
  `id_congregacao` int(10) NOT NULL,
  `id_crm` varchar(45) DEFAULT NULL,
  `exclusao` varchar(10) DEFAULT NULL COMMENT '\n'
...
INSERT INTO `ADMIN` (`id`, `chave`, `nome`, `email`, `id_congregacao`, `id_crm`, `exclusao`) VALUES
(1, 'elshaday', 'Elshaday', 'suporte@nelos.com.br', 1, NULL, NULL);
...
CREATE TABLE `ARQUIVO` (
  ...
  `exclusao` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estrutura para tabela `ARQUIVO_MINISTERIO`
--

CREATE TABLE `ARQUIVO_MINISTERIO` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura para tabela `ARQUIVO_MODELO`
--
...
CREATE TABLE `ARQUIVO_MODELO` (
  ...
  `tag_separador` varchar(45) DEFAULT NULL,
...
CREATE TABLE `CARGO` (
  ...
  `admin` int(11) NOT NULL,
  `exclusao` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `CARGO` (`id`, `nome_cargo`, `admin`, `exclusao`) VALUES
(1, 'Lider', 1, NULL),
(2, 'Vice-liderança', 1, NULL);
...
--
-- Estrutura para tabela `COMBO_DIA`
--
...
--
-- Fazendo dump de dados para tabela `COMBO_DIA`
--

INSERT INTO `COMBO_DIA` (`id`, `dia`, `exclusao`) VALUES
(1, 'Domingo', 'NULL'),
(2, 'Segunda-feira', 'NULL'),
(3, 'Terça-feira', 'NULL'),
(4, 'Quarta-feira', 'NULL'),
(5, 'Quinta-feira', 'NULL'),
(6, 'Sexta-feira', 'NULL'),
...
--
-- Estrutura para tabela `COMBO_ESCOLARIDADE`
--

CREATE TABLE `COMBO_ESCOLARIDADE` (
  `id` int(11) NOT NULL,
...
--
-- Fazendo dump de dados para tabela `COMBO_ESCOLARIDADE`
--

INSERT INTO `COMBO_ESCOLARIDADE` (`id`, `escolaridade`, `exclusao`) VALUES
(1, 'Fundamental', 'NULL'),
(2, 'Médio', 'NULL'),
(3, 'Superior', 'NULL');
...
--
-- Estrutura para tabela `COMBO_ESTADO_CIVIL`
--

CREATE TABLE `COMBO_ESTADO_CIVIL` (
  `id` int(11) NOT NULL,
  `estado_civil` varchar(250) DEFAULT NULL,
  `sexo` int(11) DEFAULT NULL COMMENT 'Define sexualidade da pessoa. \n0 para feminino\n1 para masculino',
  `exclusao` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Fazendo dump de dados para tabela `COMBO_ESTADO_CIVIL`
--

INSERT INTO `COMBO_ESTADO_CIVIL` (`id`, `estado_civil`, `sexo`, `exclusao`) VALUES
(1, 'solteiro', 1, 'NULL'),
(2, 'solteira', 0, 'NULL'),
(3, 'casado', 1, 'NULL'),
(4, 'casada', 0, 'NULL'),
...
--
-- Estrutura para tabela `COMBO_SEXO`
--

CREATE TABLE `COMBO_SEXO` (
  `id` int(11) NOT NULL,
...
--
-- Fazendo dump de dados para tabela `COMBO_SEXO`
--

INSERT INTO `COMBO_SEXO` (`id`, `sexo`, `exclusao`) VALUES
(1, 'Masculino', 'NULL'),
(2, 'Feminino', 'NULL');
...
--
-- Estrutura para tabela `CONGREGACAO`
--
...
--
-- Fazendo dump de dados para tabela `CONGREGACAO`
--

INSERT INTO `CONGREGACAO` (`id`, `nome`, `email`, `id_usuario_admin`, `exclusao`) VALUES
(1, 'Elshaday', 'suporte@nelos.com.br', 1, NULL);
...
INSERT INTO `CONTA` (`id`, `id_ministerio`, `nome`, `admin`, `exclusao`) VALUES
(14, NULL, 'Elshaday', 1, NULL),
(15, 1, 'RV', 1, NULL),
(16, 2, 'EC', 1, NULL);
...
INSERT INTO `CONTATO` (`id`, `tel`, `cel`, `email`, `skype`, `data`, `admin`, `exclusao`) VALUES
(1, '(71)9999-9999', '(22)2 2222-2222', 'gustavo@nelos.com.br', '', '2017-07-22 00:00:00', 1, NULL),
(2, '(71)9999-9999', '', 'gustavo@nelos.com.br', '', '2017-08-05 00:00:00', 1, NULL),
(3, '(71)999999999', '', 'gustavo@nelos.com.br', '', '2017-08-19 00:00:00', 1, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `CONTROLE_ACESSO`
--

CREATE TABLE `CONTROLE_ACESSO` (
  `id` int(11) NOT NULL,
  `id_modulo` int(11) NOT NULL,
  `geral` int(11) NOT NULL,
  `editar` int(11) NOT NULL,
  `visualizar` int(11) NOT NULL,
  `incluir` int(2) NOT NULL,
...
--
-- Fazendo dump de dados para tabela `CONTROLE_ACESSO`
--

INSERT INTO `CONTROLE_ACESSO` (`id`, `id_modulo`, `geral`, `editar`, `visualizar`, `incluir`, `excluir`, `id_usuario`, `admin`, `exclusao`) VALUES
(1, 1, 0, 1, 0, 0, 1, 2, 1, NULL),
(2, 4, 1, 0, 0, 0, 0, 2, 1, NULL);
...
INSERT INTO `ENDERECO` (`id`, `cep`, `estado`, `cidade`, `data`, `bairro`, `complemento`, `admin`, `exclusao`) VALUES
(1, '77.777-777', 5, 616, '2017-07-22 00:00:00', '999', 'y', 1, NULL);
...
CREATE TABLE `FATURA` (
  ...
  `mes` int(11) NOT NULL,
  `ano` int(11) NOT NULL,
  `dia_vencimento` date DEFAULT NULL,
...
INSERT INTO `FATURA` (`id`, `id_lancamento`, `mes`, `ano`, `dia_vencimento`, `data_pagamento`, `valor`, `valor_pago`, `id_conta`, `id_conta_destino`, `nfe`, `admin`, `exclusao`) VALUES
(10, 10, 8, 2017, '2017-08-05', NULL, NULL, NULL, 14, NULL, NULL, 1, NULL),
(11, 11, 1, 2017, '2017-01-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(12, 12, 1, 2017, '2017-01-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(13, 13, 1, 2017, '2017-01-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(14, 13, 2, 2017, '2017-02-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(15, 13, 3, 2017, '2017-03-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(16, 13, 4, 2017, '2017-04-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(17, 13, 5, 2017, '2017-05-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(18, 13, 6, 2017, '2017-06-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(19, 13, 7, 2017, '2017-07-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(20, 13, 8, 2017, '2017-08-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(21, 13, 9, 2017, '2017-09-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(22, 13, 10, 2017, '2017-10-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(23, 13, 11, 2017, '2017-11-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(24, 13, 12, 2017, '2017-12-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(25, 14, 1, 2017, '2017-01-27', '2017-08-27', '170', '170', 14, NULL, NULL, 1, NULL),
(26, 14, 2, 2017, '2017-02-27', '2017-08-27', '170', '170', 14, NULL, NULL, 1, NULL),
(27, 14, 3, 2017, '2017-03-27', '2017-09-29', '170', '170', 14, NULL, NULL, 1, NULL),
(28, 14, 4, 2017, '2017-04-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(29, 14, 5, 2017, '2017-05-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(30, 14, 6, 2017, '2017-06-27', '2017-08-27', '170', '170', 14, NULL, NULL, 1, NULL),
(31, 14, 7, 2017, '2017-07-27', '2017-08-27', '170', '170', 14, NULL, NULL, 1, NULL),
(32, 14, 8, 2017, '2017-08-27', '2017-08-27', '170', '170', 14, NULL, NULL, 1, NULL),
(33, 14, 9, 2017, '2017-09-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(34, 14, 10, 2017, '2017-10-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(35, 14, 11, 2017, '2017-11-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(36, 14, 12, 2017, '2017-12-27', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(37, 15, 8, 2017, '0000-00-00', NULL, NULL, NULL, 0, NULL, NULL, 1, NULL),
(38, 16, 8, 2017, '0000-00-00', NULL, NULL, NULL, 0, NULL, NULL, 1, NULL),
(39, 17, 8, 2017, '2017-08-29', NULL, NULL, NULL, 0, NULL, NULL, 1, NULL),
(40, 18, 1, 2017, '2017-01-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(41, 18, 2, 2017, '0000-00-00', '2017-08-29', '170', '170', 14, NULL, NULL, 1, NULL),
(42, 18, 3, 2017, '2017-03-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(43, 18, 4, 2017, '2017-04-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(44, 18, 5, 2017, '2017-05-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(45, 18, 6, 2017, '2017-06-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(46, 18, 7, 2017, '2017-07-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(47, 18, 8, 2017, '2017-08-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(48, 18, 9, 2017, '2017-09-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(49, 18, 10, 2017, '2017-10-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(50, 18, 11, 2017, '2017-11-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL),
(51, 18, 12, 2017, '2017-12-30', NULL, '170', NULL, 14, NULL, NULL, 1, NULL);
...
--
-- Estrutura para tabela `FREQUENCIA_ALUNO_FALTA`
--

CREATE TABLE `FREQUENCIA_ALUNO_FALTA` (
  `id` int(11) NOT NULL,
  `id_aluno` int(11) NOT NULL,
  `id_frequencia_materia` int(11) NOT NULL,
  `id_frequencia_horario` int(11) NOT NULL,
  `admin` int(11) NOT NULL,
  `exclusao` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Estrutura para tabela `FREQUENCIA_HORARIO`
--

CREATE TABLE `FREQUENCIA_HORARIO` (
  `id` int(11) NOT NULL,
  `id_frequencia_materia` int(11) NOT NULL,
...
--
-- Estrutura para tabela `FREQUENCIA_MATERIA`
--

CREATE TABLE `FREQUENCIA_MATERIA` (
  `id` int(11) NOT NULL,
  `id_frequencia` int(11) NOT NULL,
  `id_materia_serie` int(11) NOT NULL,
...
CREATE TABLE `GRUPO` (
  `id` int(11) NOT NULL,
  `nome_grupo` varchar(250) NOT NULL,
  `admin` int(11) NOT NULL,
  `exclusao` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `GRUPO` (`id`, `nome_grupo`, `admin`, `exclusao`) VALUES
(1, 'Jovens e Adolescentes', 1, NULL),
(2, 'Adultos', 1, NULL),
(3, 'Idosos', 1, NULL),
(4, 'Homens', 1, NULL),
(5, 'Mulheres', 1, NULL);
...
--
-- Estrutura para tabela `HORARIO_TURMA_MATERIA`
--

CREATE TABLE `HORARIO_TURMA_MATERIA` (
  `id` int(11) NOT NULL,
  `id_turma` int(11) NOT NULL,
  `id_materia_serie` int(11) NOT NULL,
  `id_horario_dia` int(11) NOT NULL,
  `id_horario_aula` int(11) NOT NULL,
  `admin` int(11) NOT NULL,
  `usuario` int(11) NOT NULL,
  `grupo` int(11) DEFAULT NULL,
  `exclusao` varchar(10) DEFAULT NULL
...
--
-- Estrutura para tabela `HORAS_AULA`
--
...
CREATE TABLE `LANCAMENTO` (
  ...
  `id_periodo_lancamento` int(11) NOT NULL,
  `descricao` text,
  `id_conta` int(11) NOT NULL,
  `id_conta_destino` int(11) DEFAULT NULL,
  `admin` int(11) NOT NULL,
...
INSERT INTO `LANCAMENTO` (`id`, `tipo`, `inicio`, `fim`, `valor`, `id_periodo_lancamento`, `descricao`, `id_conta`, `id_conta_destino`, `admin`, `exclusao`) VALUES
(1, 1, 8, 8, '20', 1, 'teset', 0, NULL, 1, NULL),
(2, 1, 8, 8, '170', 1, 'teste', 0, NULL, 1, NULL),
(3, 1, 9, 9, '170', 1, 'teste de recorrência', 0, NULL, 1, NULL),
(4, 1, 8, 8, '600', 1, 'Dizimos', 14, NULL, 1, NULL),
(5, 2, 8, 8, '170', 3, 'Conta de Luz', 14, NULL, 1, '2017-08-21'),
(6, 1, 1, 1, '170', 3, 'Mensalidade nova', 0, NULL, 1, '2017-08-27'),
(7, 1, 1, 1, '44', 3, 'teste de recorrência', 0, NULL, 1, '2017-08-27'),
(8, 2, 1, 1, '1000', 3, 'Mensalidade nova', 14, NULL, 1, '2017-08-27'),
(9, 1, 1, 1, '170', 3, 'Mensalidade nova', 14, NULL, 1, '2017-08-27'),
(10, 1, 8, 8, '600', 3, 'teste2', 14, NULL, 1, '2017-08-27'),
(11, 1, 1, 1, '170', 3, 'FGV', 14, NULL, 1, '2017-08-27'),
(12, 2, 1, 1, '170', 3, 'FGVg', 14, NULL, 1, '2017-08-27'),
(13, 1, 1, 12, '170', 3, 'Conta de Luz', 14, NULL, 1, '2017-08-27'),
(14, 2, 1, 12, '170', 3, 'Conta de Luz', 14, NULL, 1, NULL),
(15, 2, 8, 0, '44', 1, 'Mensalidade nova', 14, NULL, 1, '2017-08-29'),
(16, 2, 8, 0, '44', 1, 'teste', 14, NULL, 1, '2017-08-29'),
(17, 2, 8, 0, '20', 1, 'teste', 14, NULL, 1, NULL),
(18, 1, 1, 12, '170', 3, 'FGV3', 14, NULL, 1, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `LER_MENSAGEM_RESPONSAVEL`
--

CREATE TABLE `LER_MENSAGEM_RESPONSAVEL` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura para tabela `MENSAGEM_COORDENACAO_ALUNO`
--

CREATE TABLE `MENSAGEM_COORDENACAO_ALUNO` (
  `id` int(11) NOT NULL,
  `id_mensagem` int(11) NOT NULL,
...
--
-- Estrutura para tabela `MENSAGEM_COORDENACAO_ETAPA`
--

CREATE TABLE `MENSAGEM_COORDENACAO_ETAPA` (
  `id` int(11) NOT NULL,
  `id_mensagem` int(11) NOT NULL,
  `id_coordenador` int(11) NOT NULL,
...
--
-- Estrutura para tabela `MENSAGEM_COORDENACAO_TURMA`
--

CREATE TABLE `MENSAGEM_COORDENACAO_TURMA` (
  `id` int(11) NOT NULL,
  `id_mensagem` int(11) NOT NULL,
  `id_coordenador` int(11) NOT NULL,
  `id_turma` int(11) NOT NULL,
...
--
-- Estrutura para tabela `MENSAGEM_PROFESSOR_ALUNO`
--
...
--
-- Estrutura para tabela `MENSAGEM_PROFESSOR_TURMA`
--

CREATE TABLE `MENSAGEM_PROFESSOR_TURMA` (
  `id` int(11) NOT NULL,
  `id_mensagem` int(11) NOT NULL,
  `id_turma` int(11) NOT NULL,
  `id_professor_materia` int(11) NOT NULL,
...
CREATE TABLE `MINISTERIO` (
  `id` int(11) NOT NULL,
  `nome_ministerio` varchar(250) NOT NULL,
...
--
-- Fazendo dump de dados para tabela `MINISTERIO`
--

INSERT INTO `MINISTERIO` (`id`, `nome_ministerio`, `id_sala`, `id_grupo`, `admin`, `exclusao`) VALUES
(1, 'Ministério Teatral Resgatando Vidas', 1, 1, 1, NULL),
(2, 'Encontro caseiro', 1, 2, 1, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `MINISTERIO_LIDER`
--

CREATE TABLE `MINISTERIO_LIDER` (
  `id` int(11) NOT NULL,
...
--
-- Fazendo dump de dados para tabela `MINISTERIO_LIDER`
--

INSERT INTO `MINISTERIO_LIDER` (`id`, `id_pessoa`, `id_ministerio`, `id_cargo`, `admin`, `exclusao`) VALUES
(1, 1, 1, 1, 1, '2017-08-05'),
(2, 1, 1, 1, 1, '2017-08-05'),
(3, 1, 1, 1, 1, '2017-08-05'),
(4, 1, 1, 2, 1, '2017-08-05'),
(5, 1, 1, 1, 1, '2017-08-05'),
(6, 1, 1, 1, 1, '2017-08-05'),
(7, 1, 1, 1, 1, '2017-08-05'),
(8, 1, 1, 2, 1, '2017-08-05'),
(9, 1, 1, 1, 1, '2017-10-06'),
(10, 2, 2, 1, 1, NULL),
(11, 1, 1, 1, 1, NULL);
...
--
-- Estrutura para tabela `MODULO_INATIVO`
--

CREATE TABLE `MODULO_INATIVO` (
  `id` int(11) NOT NULL,
  `id_modulo` int(11) NOT NULL,
  `admin` int(11) NOT NULL,
  `exclusao` varchar(45) DEFAULT NULL
...
--
-- Estrutura para tabela `PERIODO_LANCAMENTO`
--
...
--
-- Fazendo dump de dados para tabela `PERIODO_LANCAMENTO`
--

INSERT INTO `PERIODO_LANCAMENTO` (`id`, `nome`) VALUES
(1, 'Ùnico'),
(2, 'Anual'),
(3, 'Mensal');
...
INSERT INTO `PESSOA` (`id`, `nome`, `nascimento`, `rg`, `cpf`, `estado_civil`, `escolaridade`, `sexo`, `status`, `data`, `admin`, `exclusao`) VALUES
(1, 'Gustavo de Souza Santos', '1990-09-12', '44444444444444444444', '44444444444', NULL, NULL, 1, 2, '0000-00-00', 1, NULL),
(2, 'Cleber Lima', '1990-08-29', '', '', NULL, NULL, 1, 2, '0000-00-00', 1, NULL),
(3, 'Carla Moreira da Silva', '1990-09-12', '', '', NULL, NULL, 1, 1, '2017-08-19', 1, NULL);
...
CREATE TABLE `PESSOA_CONTATO` (
  ...
  `tipo_contato` int(11) NOT NULL COMMENT 'Se o contáto é principal o valor é 0, se o contato é secundário ele é 1.',
...
--
-- Fazendo dump de dados para tabela `PESSOA_CONTATO`
--

INSERT INTO `PESSOA_CONTATO` (`id`, `id_pessoa`, `id_contato`, `tipo_contato`, `nome_contato`, `data`, `admin`, `usuario`, `grupo`, `exclusao`) VALUES
(1, 1, 1, 0, NULL, '0000-00-00', 1, 0, NULL, NULL),
(2, 2, 2, 0, NULL, '0000-00-00', 1, 0, NULL, NULL),
(3, 3, 3, 0, NULL, '0000-00-00', 1, 0, NULL, NULL);
...
CREATE TABLE `PESSOA_ENDERECO` (
  ...
  `tipo` int(11) NOT NULL COMMENT 'DEFINE O TIPO DE ENDEREÇO: SE ELE É PRINCIPAL OU SECUDÁRIO. 1 PARA PRINCIPAL E 2 PARA SECUNDÁRIO.\n',
  `nome_endereco` varchar(250) DEFAULT NULL,
  `data` datetime NOT NULL,
  `usuario` int(11) NOT NULL,
  `admin` int(11) NOT NULL,
  `grupo` int(11) DEFAULT NULL,
...
--
-- Fazendo dump de dados para tabela `PESSOA_ENDERECO`
--

INSERT INTO `PESSOA_ENDERECO` (`id`, `id_pessoa`, `id_endereco`, `tipo`, `nome_endereco`, `data`, `usuario`, `admin`, `grupo`, `exclusao`) VALUES
(1, 1, 1, 1, NULL, '0000-00-00 00:00:00', 0, 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `PESSOA_LINK`
--
...
--
-- Estrutura para tabela `PESSOA_MINISTERIO`
--
...
--
-- Fazendo dump de dados para tabela `PESSOA_MINISTERIO`
--

INSERT INTO `PESSOA_MINISTERIO` (`id`, `id_pessoa`, `id_ministerio`, `admin`, `exclusao`) VALUES
(1, 1, 1, 1, '2017-08-05'),
(2, 1, 2, 1, '2017-07-25'),
(3, 1, 1, 1, '2017-07-25'),
(4, 1, 2, 1, '2017-07-25'),
...
--
-- Estrutura para tabela `PESSOA_RELACAO`
--
...
CREATE TABLE `PESSOA_RELACAO` (
  ...
  `id_tipo_relacionado` int(11) NOT NULL,
...
CREATE TABLE `SALA` (
  `id` int(11) NOT NULL,
  `nome_sala` varchar(250) NOT NULL,
...
INSERT INTO `SALA` (`id`, `nome_sala`, `capacidade`, `admin`, `exclusao`) VALUES
(1, '01', 60, 1, NULL);
...
--
-- Estrutura para tabela `STATUS_SITUACAO`
--
...
--
-- Fazendo dump de dados para tabela `STATUS_SITUACAO`
--

INSERT INTO `STATUS_SITUACAO` (`id`, `nome`, `exclusao`) VALUES
(1, 'Não concluído', 'NULL'),
(2, 'Concluído', 'NULL');

-- --------------------------------------------------------

--
-- Estrutura para tabela `TIPO_ASSINATURA`
--

CREATE TABLE `TIPO_ASSINATURA` (
  `id` int(11) NOT NULL,
  `nome` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='O tipo de assinatura é dividido em 2:\n\n1 - Institucional\n	Quando uma escola paga pelo uso do aplicativo ela só tem um contrato"assinatura" para toda a escola por cada ano\n\n2- Individual\n	 Quando o responsável paga pela assinatura de seu aluno . Nesse caso cada aluno tem um contrato';

--
-- Fazendo dump de dados para tabela `TIPO_ASSINATURA`
--

INSERT INTO `TIPO_ASSINATURA` (`id`, `nome`) VALUES
(1, 'Institucional'),
(2, 'Individual');
...
--
-- Estrutura para tabela `TIPO_BOLETO`
--
...
--
-- Estrutura para tabela `TIPO_LANCAMENTO`
--
...
--
-- Fazendo dump de dados para tabela `TIPO_LANCAMENTO`
--

INSERT INTO `TIPO_LANCAMENTO` (`id`, `nome`) VALUES
(1, 'ENTRADA'),
(2, 'SAÌDA');
...
--
-- Estrutura para tabela `TIPO_LINK`
--
...
--
-- Estrutura para tabela `TIPO_RELACAO`
--
...
INSERT INTO `USUARIO` (`id`, `tipo`, `nome`, `email`, `senha`, `admin`, `exclusao`) VALUES
(1, 1, '', 'suporte@nelos.com.br', 'bbfe93679e36147481d8031e55785270', 1, NULL),
(2, 2, 'Gustavo', 'gustavo@nelos.com.br', 'bbfe93679e36147481d8031e55785270', 1, NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `VISTO_FREQUENCIA`
--

CREATE TABLE `VISTO_FREQUENCIA` (
  `id` int(11) NOT NULL,
...
--
-- Estrutura para tabela `VISTO_MENSAGEM`
--

CREATE TABLE `VISTO_MENSAGEM` (
  `id` int(11) NOT NULL,
  `id_mensagem` int(11) NOT NULL,
  `id_pessoa` int(11) NOT NULL,
...
--
-- Índices de tabela `ARQUIVO_MINISTERIO`
--
ALTER TABLE `ARQUIVO_MINISTERIO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `ARQUIVO_MODELO`
--
ALTER TABLE `ARQUIVO_MODELO`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `COMBO_DIA`
--
ALTER TABLE `COMBO_DIA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `COMBO_ESCOLARIDADE`
--
ALTER TABLE `COMBO_ESCOLARIDADE`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `COMBO_ESTADO_CIVIL`
--
ALTER TABLE `COMBO_ESTADO_CIVIL`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `COMBO_SEXO`
--
ALTER TABLE `COMBO_SEXO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `CONGREGACAO`
--
...
--
-- Índices de tabela `CONTROLE_ACESSO`
--
...
--
-- Índices de tabela `FREQUENCIA_ALUNO_FALTA`
--
ALTER TABLE `FREQUENCIA_ALUNO_FALTA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `FREQUENCIA_HORARIO`
--
ALTER TABLE `FREQUENCIA_HORARIO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `FREQUENCIA_MATERIA`
--
ALTER TABLE `FREQUENCIA_MATERIA`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `HORARIO_DIA`
--
ALTER TABLE `HORARIO_DIA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `HORARIO_TURMA_MATERIA`
--
ALTER TABLE `HORARIO_TURMA_MATERIA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `HORAS_AULA`
--
...
--
-- Índices de tabela `LER_MENSAGEM_RESPONSAVEL`
--
ALTER TABLE `LER_MENSAGEM_RESPONSAVEL`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `MENSAGEM_COORDENACAO_ALUNO`
--
ALTER TABLE `MENSAGEM_COORDENACAO_ALUNO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `MENSAGEM_COORDENACAO_ETAPA`
--
ALTER TABLE `MENSAGEM_COORDENACAO_ETAPA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `MENSAGEM_COORDENACAO_TURMA`
--
ALTER TABLE `MENSAGEM_COORDENACAO_TURMA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `MENSAGEM_PROFESSOR_ALUNO`
--
ALTER TABLE `MENSAGEM_PROFESSOR_ALUNO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `MENSAGEM_PROFESSOR_TURMA`
--
ALTER TABLE `MENSAGEM_PROFESSOR_TURMA`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `MINISTERIO_LIDER`
--
ALTER TABLE `MINISTERIO_LIDER`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `MODULO_INATIVO`
--
ALTER TABLE `MODULO_INATIVO`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `PERIODO_LANCAMENTO`
--
ALTER TABLE `PERIODO_LANCAMENTO`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `PESSOA_LINK`
--
ALTER TABLE `PESSOA_LINK`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `PESSOA_MINISTERIO`
--
ALTER TABLE `PESSOA_MINISTERIO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `PESSOA_RELACAO`
--
...
--
-- Índices de tabela `STATUS_SITUACAO`
--
ALTER TABLE `STATUS_SITUACAO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `TIPO_ASSINATURA`
--
ALTER TABLE `TIPO_ASSINATURA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `TIPO_BOLETO`
--
ALTER TABLE `TIPO_BOLETO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `TIPO_LANCAMENTO`
--
ALTER TABLE `TIPO_LANCAMENTO`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `TIPO_LINK`
--
ALTER TABLE `TIPO_LINK`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `TIPO_MENSAGEM`
--
ALTER TABLE `TIPO_MENSAGEM`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `TIPO_RELACAO`
--
ALTER TABLE `TIPO_RELACAO`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices de tabela `VISTO_FREQUENCIA`
--
ALTER TABLE `VISTO_FREQUENCIA`
  ADD PRIMARY KEY (`id`);

--
-- Índices de tabela `VISTO_MENSAGEM`
--
ALTER TABLE `VISTO_MENSAGEM`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de tabela `ARQUIVO_MINISTERIO`
--
ALTER TABLE `ARQUIVO_MINISTERIO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `ARQUIVO_MODELO`
--
ALTER TABLE `ARQUIVO_MODELO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de tabela `COMBO_DIA`
--
ALTER TABLE `COMBO_DIA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de tabela `COMBO_ESCOLARIDADE`
--
ALTER TABLE `COMBO_ESCOLARIDADE`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `COMBO_ESTADO_CIVIL`
--
ALTER TABLE `COMBO_ESTADO_CIVIL`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de tabela `COMBO_SEXO`
--
ALTER TABLE `COMBO_SEXO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `CONGREGACAO`
--
ALTER TABLE `CONGREGACAO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `CONTATO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de tabela `CONTROLE_ACESSO`
--
ALTER TABLE `CONTROLE_ACESSO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `FREQUENCIA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `FREQUENCIA_ALUNO_FALTA`
--
ALTER TABLE `FREQUENCIA_ALUNO_FALTA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `FREQUENCIA_HORARIO`
--
ALTER TABLE `FREQUENCIA_HORARIO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `FREQUENCIA_MATERIA`
--
ALTER TABLE `FREQUENCIA_MATERIA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `HORARIO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `HORARIO_DIA`
--
ALTER TABLE `HORARIO_DIA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `HORARIO_TURMA_MATERIA`
--
ALTER TABLE `HORARIO_TURMA_MATERIA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `HORAS_AULA`
--
ALTER TABLE `HORAS_AULA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de tabela `LER_MENSAGEM_RESPONSAVEL`
--
ALTER TABLE `LER_MENSAGEM_RESPONSAVEL`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `MENSAGEM`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `MENSAGEM_COORDENACAO_ALUNO`
--
ALTER TABLE `MENSAGEM_COORDENACAO_ALUNO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `MENSAGEM_COORDENACAO_ETAPA`
--
ALTER TABLE `MENSAGEM_COORDENACAO_ETAPA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `MENSAGEM_COORDENACAO_TURMA`
--
ALTER TABLE `MENSAGEM_COORDENACAO_TURMA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `MENSAGEM_PROFESSOR_ALUNO`
--
ALTER TABLE `MENSAGEM_PROFESSOR_ALUNO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `MENSAGEM_PROFESSOR_TURMA`
--
ALTER TABLE `MENSAGEM_PROFESSOR_TURMA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `MINISTERIO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `MINISTERIO_LIDER`
--
ALTER TABLE `MINISTERIO_LIDER`
...
ALTER TABLE `MODULO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `MODULO_INATIVO`
--
ALTER TABLE `MODULO_INATIVO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `PAIS`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `PERIODO_LANCAMENTO`
--
ALTER TABLE `PERIODO_LANCAMENTO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
ALTER TABLE `PESSOA_ENDERECO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `PESSOA_LINK`
--
ALTER TABLE `PESSOA_LINK`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `PESSOA_MINISTERIO`
--
ALTER TABLE `PESSOA_MINISTERIO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de tabela `PESSOA_RELACAO`
--
ALTER TABLE `PESSOA_RELACAO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `SALA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de tabela `STATUS_SITUACAO`
--
ALTER TABLE `STATUS_SITUACAO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `TIPO_ASSINATURA`
--
ALTER TABLE `TIPO_ASSINATURA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `TIPO_BOLETO`
--
ALTER TABLE `TIPO_BOLETO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `TIPO_LANCAMENTO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `TIPO_LINK`
--
ALTER TABLE `TIPO_LINK`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `TIPO_MENSAGEM`
--
ALTER TABLE `TIPO_MENSAGEM`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `TIPO_RELACAO`
--
ALTER TABLE `TIPO_RELACAO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `USUARIO`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de tabela `VISTO_FREQUENCIA`
--
ALTER TABLE `VISTO_FREQUENCIA`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de tabela `VISTO_MENSAGEM`
--
ALTER TABLE `VISTO_MENSAGEM`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
